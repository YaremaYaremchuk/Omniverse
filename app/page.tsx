  ...
  const features = [
    {
      ...
      description:
        "Advanced algorithms adapt to your learning style, creating personalized paths to mastery.",
    },
    {
      icon: <Rocket className="w-12 h-12 text-purple-400" />,
      title: "Accelerated Progress",
      description:
        "Learn up to 5x faster with our optimized curriculum and adaptive testing system.",
    },
    {
      icon: <Clock className="w-12 h-12 text-purple-400" />,
      title: "On-Demand Access",
      description:
        "Learn anytime, anywhere, with 24/7 access to expert-curated content and resources.",
    },
    {
      icon: <Shield className="w-12 h-12 text-purple-400" />,
      title: "Guaranteed Results",
      description:
        "Our proven methodology ensures measurable improvement or your money back.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Join millions of learners in our vibrant, supportive learning community.",
    },
  ];
          ...
          <div className="container mx-auto px-6">
            <div className="flex flex-col items-center gap-12">
              ...
              <p className="text-2xl text-center text-white opacity-0 animate-on-scroll">
                ...
                <span className="underline italic">personal</span> tutoring.
              </p>

              {/* Second sentence with scroll effect */}
              <div className="text-center opacity-0 animate-on-scroll">
                <p className="text-xl text-gray-200">
                  Omnivision allows you to take control of what you want to
                  learn, and when you can learn it.
                </p>
              </div>
            ...
            <div className="flex flex-col items-center gap-12">
              ...
              <div className="text-center max-w-2xl opacity-0 animate-on-scroll">
                <p className="text-lg text-white">
                  What if tutoring no longer had to rely on the tutor's
                  availability? What if you could dictate when to learn?
                  Omnivision is here to make that a reality.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col items-center gap-16">
              ...
              <div className="text-center space-y-4 opacity-0 animate-on-scroll">
                <h2 className="text-4xl font-bold text-white">
                  Why Choose Omniverse?
                </h2>
                <p className="text-xl text-purple-200 max-w-2xl mx-auto">
                  Experience the future of education with our cutting-edge
                  platform that's revolutionizing how people learn.
                </p>
              </div>
              ...
              <div className="text-center space-y-6 opacity-0 animate-on-scroll">
                <p className="text-xl text-purple-200">
                  Join the educational revolution where students who have
                  transformed their learning journey
                </p>
                <button
                  className="px-8 py-4 bg-purple-600 hover:bg-purple-700 text-white font-semibold rounded-md 
