...
const TutorCall = ({ params }: { params: { uuid: string } }) => {
  const tutorId = params.uuid;
  ...
  //need to insert logic to call endpoint here.
  ...
  return (
    <div className="w-full flex flex-col">
      ...
      <div className="bg-gray-800 p-4 rounded-lg">
        ...
        <p className="text-white font-mono whitespace-pre-wrap mt-2">
          {transcription}
        </p>
      </div>
